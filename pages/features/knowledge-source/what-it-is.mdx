...
Ever wonder how to provide custom data to your AI or how to control exactly what data to be given to it? When using MindPal, you have the ability to do so with knowledge sources.

## What exactly is a knowledge source?

In simple terms, it is a source of knowledge that you can provide to your agents for more effective results. These knowledge sources may come in many shapes and forms, be it your documents, websites, data from third-party apps, your voice and notes, or information from external platforms.
...
- **Pexels**: Find high-quality images and videos.
